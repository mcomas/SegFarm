...
sel =  month(df$data) == 8
table(ifelse(sel, 'Guardies d\'agost', 'Guàrdies d\'altres mesos'))
df = df[sel, ]
```
...
```{r, echo=FALSE, comment=""}
save(t01, t01.hora, t01.proc, t01.grup, t01.tip, t01.farm, t02, t03, file='../data/tables_agost.RData')
```