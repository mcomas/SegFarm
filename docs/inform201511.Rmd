---
title: "Informe Novembre"
author: "Marc Comas-Cufí"
date: "7 de gener del 2016"
output: 
  html_document: 
    toc: yes
  word_document:
...
table(ifelse(sel, 'Guardies de novembre', 'Guàrdies d\'altres mesos'))
df = df[sel, ]
```
...
```{r, echo=FALSE, comment=""}
save(t01, t01.hora, t01.proc, t01.grup, t01.tip, t01.farm, t02, t03, file='../data/tables_novembre.RData')
```
