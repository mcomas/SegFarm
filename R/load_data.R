...
#Guardies del mes
guard_mes = read.xls(paste0(ROOT, "data/Relacio_OF_participants-actives.xls"), encoding= 'latin1', stringsAsFactors = F)
...
res = read.xls(paste0(ROOT, "data/Dades_Enquesta_febrer_01_19.xls"), encoding= 'latin1', stringsAsFactors = F)
...
guard_mes$Num.Of = as.numeric(gsub(',', '', guard_mes$Num.Of))
