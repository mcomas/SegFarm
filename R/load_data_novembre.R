...
#Guardies del mes
guard_mes = read_excel(paste0(ROOT, "data/2015-11/Llista OF_Participants_Enq_Guardies_Novembre_15.xls"), 
...
res = read_excel(paste0(ROOT, "data/2015-11/Enquesta_guardies_novembre_15.xls")) %>%
